---
title: "RAG 系统的 Query 改写与扩展：检索效果差，很多时候不是向量库的问题"
description: "用户输入一个短 query 就直接去检索，是 RAG 系统中最常见的性能杀手。本文从工程角度拆解 Query 改写（HyDE、Multi-Query、Query Decomposition）的适用场景、实现代价和落地效果，帮你判断什么时候该改、怎么改。"
date: "2026-08-09"
category: "rag"
tags: ["Query Rewriting", "HyDE", "Multi-Query", "Query Decomposition", "RAG", "检索优化", "工程落地"]
