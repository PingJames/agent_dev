---
title: "Multi-Agent 系统中的任务路由设计：从静态分配到动态编排"
description: "从工程视角拆解 Multi-Agent 任务路由的核心模式与落地陷阱，涵盖静态分配、ReAct 动态路由、Plan-and-Solve 及 LLM-as-Router 四种方案的设计与选型。"
date: "2026-08-03"
category: "agent"
tags: ["Multi-Agent", "任务路由", "动态编排", "架构设计", "Plan-and-Solve", "ReAct"]
